...
def display_predictions(val_ds, model, class_names, num_images=5):
    # 获取验证集中的所有图片和标签
...
model = tf.keras.Sequential([
    ...
    Conv2D(filters=64,kernel_size=(5,5),activation='relu',padding='same'),  # 增加filter个数，增加模型拟合能力
...
display_predictions(val_ds, model, class_names, num_images=30)
